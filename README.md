...
2. If you want to schedule the periodic tool execution, copy the [ec2_amis](cron.d/ec2_amis) template to the `/etc/cron.d` path and replace the existing `<tags>` with the appropiate values:
